...
class ProphetsTree : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        graph.addEdge(utils.noah, utils.methusaleh)
        graph.addEdge(utils.noah, utils.heber)
        graph.addEdge(utils.abraham, utils.ishmael)
        graph.addEdge(utils.ishmael, utils.empty)
        graph.addEdge(utils.empty, utils.muhammad)
        ...
        graph.addEdge(utils.solomon, utils.dahsed)
        graph.addEdge(utils.dahsed, utils.jesus)
        graph.addEdge(utils.solomon, utils.zecharia)
        ...
        graph.addEdge(utils.aron, utils.eisha)
        graph.addEdge(utils.job, utils.isiah)
